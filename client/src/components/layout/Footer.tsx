    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Comprehensive career assessment platform combining RIASEC, Aptitude, and OCEAN frameworks.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li>
                <Link href="/dashboard">
                  <a className="hover:text-white transition-colors">Sample Results</a>
                </Link>
              </li>
              <li>
                <Link href="/#">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/#">
                  <a className="hover:text-white transition-colors">Career Guide</a>
                </Link>
              </li>
              <li>
                <Link href="/#">
                  <a className="hover:text-white transition-colors">Assessment Frameworks</a>
                </Link>
              </li>
              <li>
                <Link href="/#">
                  <a className="hover:text-white transition-colors">Career Research</a>
                </Link>
              </li>
              <li>
                <Link href="/#">
        ...
        <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">&copy; 2023 CareerInsight. All rights reserved.</p>
